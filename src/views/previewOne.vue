    ...
    <section v-if="live">
      ...
      <div class="content" v-else>
        ...
        <div class="wistia_responsive_wrapper">
          <div class="wistia_embed wistia_async_ec3nffdn57 videoFoam=true playbar=true fullscreenButton=true  playButton=false autoPlay=false">&nbsp;</div>
        </div>
  ...
  export default {
    ...
    data () {
      return {
        loading: true,
        live: false,
        pageTitle: "Live Event Preview Part 1",
        currentDate: '',
        currentTime: '',
